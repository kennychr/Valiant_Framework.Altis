...
//--------Specialist Roles
      //--------Medium Machine Gun
      case 'MG_T'   : { []call AW_fnc_Loadout_MG_T  };//Medium Machine Gun Teamlead
      case 'MG_A'   : { []call AW_fnc_Loadout_MG_A  };//Medium Machine Gun Assistant
      case 'MG_G'   : { []call AW_fnc_Loadout_MG_G  };//Medium Machine Gun Gunner
      //--------Medium Anti Tank
